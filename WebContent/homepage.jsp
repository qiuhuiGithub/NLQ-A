...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <br><br><br><br>
	<form action="sparql.action" method="post">
	 <table height="80px" align="center">
    	<tr height="80px">
    		...
    		<td width="200"><input type="radio" name="queryType" value = "1"checked>SPARQL查询</td>
	...
	<table align="center">
	<tr>
				<td ><input type="text" name="sparqlString"  maxlength="1000" style="width:700px; height:40px;"></td>
				<td border="1"><input type="submit" name="submit" value="gStore一下"style=height:40px;"></td>
	</tr>
	</table>
	</form>
        ...
        <td width ="200">&nbsp;</td>
          <!-- <td><a href="login.jsp"><img src="images/admin.jpg" /></td>
            <td><a href="login.jsp"><img src="images/date.jpg" /></a></td>
              ...
              <td width ="600"align ="center">copyright(C) 哈尔滨工业大学<br>联系我们:qiuhui@hit.edu.cn</td>
